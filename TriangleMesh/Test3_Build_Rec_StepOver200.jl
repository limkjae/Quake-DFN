...
function BuildBulk()
    ...
    Fault1Center=[-250.0, 100.0, 500.0]
    Fault1StrikeAngle = 0.0
    Fault1DipAngle = 90.0
    Fault1Strikelength = 1000.0


    Fault2Center=[250.0, -100.0, 500.0]

    Fault2DipAngle = 90.0
    Fault2StrikeAngle = 0.0
    Fault2Strikelength = 1000.0
    
    Theta_i = 1e10
    V_i = 1e-15

    MaxDiscritLength=20.0
    

    ############################# Write Bulk Input #################################
    ######++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++######
    ## Bulk File Order 
    ##  1.Ctr_X     2.Ctr_Y 3.Ctr_Z 4.St_L	    5.Dip_L	    6.StAng	    7.DipAng	8.Rake (-1: LL / +1 RL or -1:Reverse / +1 Normal)
    ...
    ### Fault 1.     
    Fault[1,1]=Fault1Center[1] 
    Fault[1,2]=Fault1Center[2] 
    Fault[1,3]=Fault1Center[3] 

    Fault[1,4] = Fault1Strikelength 
    Fault[1,5] = Fault[1,3]*2;
    Fault[1,6] =Fault1StrikeAngle;
    Fault[1,7] =Fault1DipAngle;
    ### Fault 2     
    Fault[2,1:3]=Fault2Center
    Fault[2,4]=Fault2Strikelength

...
function BuildInputFromBulkGeometry_H()
    ...
    #####---------   Plots?  --------#####
    Plot_DiscretizedBlock = 0
    PlotHMat = 0 # HMatrix structure plot
    PlotBlock3DHMat = 0 # Blocks in 3D plot
    ######################################
    ...
    if HMatrixCompress == 1
        if isfile(HMatrixStructureFile)            
            ...
            ShearModulus, PoissonRatio, RockDensity, DropCrit, DropCritNormalStressMultiplier, MinimumNS =

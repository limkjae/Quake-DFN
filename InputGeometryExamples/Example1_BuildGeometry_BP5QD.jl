...
function BuildBulk()
    ...
    Unstable_Dc=0.14
    Unstable_Theta=1e9
    UntableMaximumSegLength=1000.0
    ...
    println("Total ",size(InputFile,1)," Faults Generated (", size(Stable_Faults,1), " Regular faults, ", size(Loading_Faults,1)," Loading Faults)" )

...
for ElemIdx = 1 : TotalElemCount
    ...
    P1_i = [P1[ElemIdx,1], P1[ElemIdx,2], P1[ElemIdx,3]]
    P2_i = [P2[ElemIdx,1], P2[ElemIdx,2], P2[ElemIdx,3]]
    P3_i = [P3[ElemIdx,1], P3[ElemIdx,2], P3[ElemIdx,3]]
    ...
    if isnan(UnitVector_StrikeSlip[ElemIdx,1])
        UnitVector_StrikeSlip[ElemIdx,:] = [1,0,0]
        UnitVector_NormalSlip[ElemIdx,:] = [0,1,0]
    end

...
ax.set_aspect("equal")
    ...
    LP1 = [10000, -1000, 0]
    LP2 = [10000, -1000, -10000]
    LP3 = [-10000, -1000, 0]
    LoadingV = 1e-9
    LPInput = [LP1; LP2; LP3; Rake+180;  a; b; Dc; Thata_i;  V_i;  Friction_i;  NormalStressAtSurface;  NormalStressGradient;  LoadingV; MinimumSegmentLength]
    InputFile = [InputFile ; LPInput']
    LP1 = [-10000, -1000, 0]
    LP3 = [-10000, -1000, -10000]
    LP2 = [10000, -1000, -10000]
    LoadingV = 1e-9
    LPInput = [LP1; LP2; LP3; Rake+180;  a; b; Dc; Thata_i;  V_i;  Friction_i;  NormalStressAtSurface;  NormalStressGradient;  LoadingV; MinimumSegmentLength]
    InputFile = [InputFile ; LPInput']

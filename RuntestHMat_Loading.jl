...
Par_ElementDivisionNoLoading = copy(Par_ElementDivision)
Par_ElementDivisionNoLoading[end] = Par_ElementDivisionNoLoading[end]-1
println("Initializing")
InitialShearStress = InitialNormalStress .* FrictionI;
Far_Load_Disp_Initial = SolveAx_b(LoadingStiffnessH[2:end], K_Self[1:end-5], InitialShearStress[1:end-5], 
        ElementRange_SR[2:end,:], FaultCount-5, Par_ElementDivisionNoLoading, ThreadCount, Epsilon_MaxDiffRatio)
